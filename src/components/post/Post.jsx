...
export default function Post() {
  ...
  return (
    <div className="postLeftWrapper">
      <div data-aos="fade-up" className="blogCard">
        <img src={Image1} alt="" />
        <div className="blogInfo">
          <h1> REMODELING PROJECTS THAT WILL BOOST YOUR HOME’S</h1>
          <p>
      ...
      <div data-aos="fade-up" className="blogCard">
        <img src={Image2} alt="" />
        <div className="blogInfo">
          <h1> SIGNS THAT NOW IS THE TIME TO SELL YOUR HOME</h1>
          <p>
            There are two ways to think about remodeling projects that will
            boost your home’s value; you can get one or two major remodels done
            or opt for a bunch of small fixes. Depending on your budget and your
